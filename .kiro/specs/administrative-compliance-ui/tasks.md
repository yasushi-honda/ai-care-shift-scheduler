...
- [x] 1. 書類アーカイブのデータ基盤を構築する
- [x] 1.1 書類アーカイブに必要な型定義を追加する
...
- [x] 1.2 Firestoreに書類メタデータを保存・取得する機能を実装する
...
- [x] 1.3 Firestoreセキュリティルールに書類アーカイブのアクセス制御を追加する
...
- [x] 2. Excelエクスポート後に書類アーカイブを自動記録する
- [x] 2.1 既存のExcelエクスポートUIにアーカイブ記録処理を組み込む
...
- [x] 3. 書類アーカイブ一覧UIと再ダウンロード機能を実装する
- [x] 3.1 書類アーカイブ一覧パネルを作成する
...
- [x] 5. 運営指導モードのトグルとダッシュボード基盤を実装する
- [x] 5.1 シフト管理画面のヘッダーに運営指導モードトグルを追加する
...
- [x] 7. 電子申請フロー案内モーダルを実装する
- [x] 7.1 電子申請の4ステップ案内モーダルを作成する
...
- [x] 9. TypeScriptの型チェックを通してビルドを確認する
- [x] 9.1 全実装コードのTypeScriptエラーをゼロにする
