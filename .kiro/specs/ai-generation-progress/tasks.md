...
- [x] 2. プログレス表示コンポーネントを実装する
- [x] 2.1 ステップ表示コンポーネントを作成する
...
- [x] 4. アクセシビリティとレスポンシブ対応を実装する
- [x] 4.1 アクセシビリティ対応を実装する
