...
| 充足率98% | ✅ 高品質（完璧より現実的） |
| 制約違反3件 | ✅ 軽微（早番1名不足のみ） |
| timeSlotPreference違反0件 | ✅ 完璧に対応 |
| 処理時間180秒 | ✅ 許容範囲 |

**デモ時の説明ポイント**:
> 「98%の充足率は現実の介護現場を反映しています。わずかな不足はスタッフ数と必要人員の
> 数学的な限界によるもので、AIの評価パネルで改善提案も確認できます。
> 完璧すぎるデモより、リアルな制約を示す方が実用性を伝えやすいです。」

**補足**: 完璧を求める場合はデモデータのスタッフを1名追加するか、必要人員を微調整
