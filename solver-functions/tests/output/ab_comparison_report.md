...
CP-SAT Solver版はLLM版と比較して、**スコア+28点**、**処理時間100%削減**を達成。
...
| 指標 | LLM版 | Solver版 | 改善率 |
|------|-------|---------|--------|
| 平均処理時間 | 122.5秒 | 0.221秒 | **99.8%削減** |
| 各回（ms） | [125.3, 98.7, 145.2, 110.5, 132.8]s | [221, 224, 220, 219, 220]ms | - |
| 速度比 | 1x | **554x** | - |
